...
#define ipconfigIP_TASK_STACK_SIZE_WORDS	( configMINIMAL_STACK_SIZE * 30 )
...
#define ipconfigTCP_RX_BUFFER_LENGTH			( 3 * 1536 )

/* Define the size of Tx buffer for TCP sockets. */
#define ipconfigTCP_TX_BUFFER_LENGTH			( 2 * 1536 )
